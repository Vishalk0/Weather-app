...
//9a321d5e610d0107162e16291940332a
...
//it is use to convert the data who is fetch from api and convert by retrofit..

       val retrofit=Retrofit.Builder()
           .addConverterFactory(GsonConverterFactory.create())
           .baseUrl("https://api.openweathermap.org/data/2.5/")
           .build().create(ApiInterface::class.java)
       val response=retrofit.getWeatherData(cityName,"9a321d5e610d0107162e16291940332a","metric")
...
//                   Log.d("API","onResponse: $temperature")
...
//
                   ...
                   val seapressers=responseBody.main.pressure
                   ...
                   binding.humi.text="$humidity"
                   binding.windspeed.text="$windSpeed hPa"
                   binding.condition.text=condition
                   binding.seapresser.text="$seapressers"
                   binding.day.text=dayName(System.currentTimeMillis())
//                       binding.datetime.text=date()
                       binding.cityname.text="$cityName"
                   changeImageaccourdingWeatherCondition(condition)
    ...
    private fun changeImageaccourdingWeatherCondition(condition:String) {


        when(condition){
            "clear sky","sunny","Clear" ,"clear" ->{
            ...
            "Light Rain","Drizzel","Moderate Rain","Shower","Heavy Rain" ,"Smoke","Rain" -> {
